...
class AttributeNames(CybsiAPIEnum):
    ...
    MalwareFamilyAliases = "MalwareFamilyAliases"  # doc: Aliases of malware family.
    ...
    MalwareClasses = "MalwareClasses"  # doc: The file belongs to malware class
    MalwareFamilies = "MalwareFamilies"  # doc: The file belongs to a malware family
    RelatedMalwareFamilies = "RelatedMalwareFamilies"  # noqa: E501 doc: The entity except File belongs to related malware family
